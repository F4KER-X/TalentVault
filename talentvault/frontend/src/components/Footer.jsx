    ...
    <div className="main-footer">
        <div className="container">
            <div className="intro-text">
                <h3>TalentVault</h3>
                <p className="intro-text2"> TalentVault is a career-services platform that helps applicants find their dream job, and helps recruiters find their dream applicant!</p>
            </div>
