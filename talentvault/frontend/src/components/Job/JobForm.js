...
const JobForm = ({ job, jobDescription, setJobDescription, handleInputChange, saveJob, error, salaryError }) => {
                        ...
                        <div className="job-details">
                            ...
                            <div className={`salary-div`}>
                                <div className="floater">
                                    ...
                                    <input
                                        className={error && !job?.maxSalary ? 'error' : '' || salaryError ? 'error' : ''}
                                        type="number"
                                ...
                                <div className="floater">
                                    ...
                                    <input
                                        className={error && !job?.minSalary ? 'error' : '' || salaryError ? 'error' : ''}
                                        type="number"
                            ...
                            <div className="Employment-Type">
                                <div className="floater">
                                    ...
                                    <select
                                        ...
                                        aria-required="true"
                                    >
                                        <option className="dropdown_options" value="Full-time"> Full-time</option>
                                        <option className="dropdown_options" value="Part-time">Part-time</option>
